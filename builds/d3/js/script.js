d3.json('https://api.openweathermap.org/data/2.5/forecast?id=4466900&APPID=196361824cdde9ece4cb463f7db774f2&units=imperial', function(d) {
      ...
      .on('mouseover', function(d, i) {
        ...
        tooltip.html(
          '<div style="font-size: 2rem; font-weight: bold">' +
            d  + '&deg;' + " " + dates[i].toTimeString() +'</div>'
        )
